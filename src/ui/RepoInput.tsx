...
export function RepoInput({
  ...
  return (
    <form
      className="group flex items-center gap-[7px] rounded-md border border-rule bg-panel px-[9px] py-[3px] focus-within:border-accent"
      onSubmit={(e) => {
        e.preventDefault();
        submit();
      }}
    >
      <span className="inline-flex text-ink-soft group-focus-within:text-accent" aria-hidden="true">
        <GitHubMark />
      </span>
      <input
        list="cqx-repos"
        ...
        size={22}
        className="border-0 bg-transparent p-0 font-mono text-[12.5px] text-ink outline-none placeholder:text-ink-faint"
